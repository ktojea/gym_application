...
class _$ExerciseInListImpl extends _ExerciseInList {
  ...
  @override
  String toString() {
    return 'ExerciseInList(id: $id, name: $name, description: $description, imageUrl: $imageUrl, equipmentId: $equipmentId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, imageUrl, equipmentId);
...
abstract class _ExerciseInList extends ExerciseInList {
  const factory _ExerciseInList(
      ...
      required final int equipmentId}) = _$ExerciseInListImpl;
